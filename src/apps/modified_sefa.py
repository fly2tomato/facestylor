...
if __name__ == '__main__':
    ...
    print('Building models and loading checkpoints', 'mmgen')
    # build model
    ...
    print('Calculating or loading eigen vectors', 'mmgen')
    ...
    print('Sampling images with modified SeFa', 'mmgen')
    ...
    print(f'Save images to {filename}', 'mmgen')
